...
try:
    ...
    result = db.view("running_balance/list_running_balance")
    ...
    db_info = db.info()
    for data in db.changes(filter='running_balance/not_mongo_synced', feed='continuous', heartbeat=1000, since=db_info['update_seq']):
