...
def process_doc_id(doc_id):
    ...
    mailbox = dict(
        ...
        generated_by = 'celery attendance_report.process_doc_id',
        html = None,
        text = 'executing attendance_report.process_doc_id %s' % doc_id,        
        subject = 'executing attendance_report.process_doc_id %s' % doc_id,
        to = to            
    )
