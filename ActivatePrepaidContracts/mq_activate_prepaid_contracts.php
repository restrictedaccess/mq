...
include 'activate_prepaid_contract.php';
...
//$queue = 'activate_prepaid_contract';
...
function process_message($msg) {
	...
	//function to activate and approved scheduled prepaid contracts
	echo activate_prepaid_contract($msg->body);
